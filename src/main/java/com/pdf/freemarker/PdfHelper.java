...
public class PdfHelper {
    ...
    private static Configuration getFreemarkerConfig(String templatePath) throws IOException {
        ...
        String templatePathNew = "D:\\cpu\\lcIdeaTest\\pdf-kit\\src\\main\\java\\com\\pdf\\freemarker\\tpl.ftl";
        config.setDirectoryForTemplateLoading(new File(templatePathNew));
